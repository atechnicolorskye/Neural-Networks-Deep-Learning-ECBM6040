...
class myMLP_2B(object):
    def __init__(self, rng, input, n_in, n_hidden, n_out, n_layers, activation):

        # create 2 hidden layers

        self.hl_1 = HiddenLayer(rng=rng,
                                input=input,
                                n_in=n_in,
                                n_out=n_hidden,
                                activation=activation)
        self.hl_2 = HiddenLayer(rng=rng,
                                input=self.hl_1.output,
                                n_in=n_hidden,
                                n_out=n_hidden,
                                activation=activation)
        ...
        self.params = self.hl_1.params + self.hl_2.params + self.logRegressionLayer.params
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
    ...
    # load_data returns data as theano shared values
    datasets = load_data()
...
# The code for file hw2b_2.py ran for 0.52m